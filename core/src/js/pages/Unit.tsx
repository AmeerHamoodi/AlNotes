...
const Unit = observer(({ match }: RouteComponentProps<RouteDetails>) => {
    ...
    return (
        <>
            <Navbar
                backLink={`/class/${match.params.className}`}
            ...
            <Container className="mt">
                ...
                <div className="container mt">
                    <Error
                        toShow={notesStore.errorContent.occured}
                        textToShow={notesStore.errorContent.data}
                    ></Error>
                    <CreateNew
                        title="New note"
                        creationText="Create new note"
                        onClick={createNote}
                    >
                        <div className="field">
