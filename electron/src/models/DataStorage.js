...
class DataStorage {
    ...
    noteExists(className, unitName, id) {
        return (
            id in
            this.db.classes[className.toLowerCase()].units[
    ...
    getNotes(className, unitName) {
        if (
            typeof this.db.classes[className.toLowerCase()] === "undefined" ||
            typeof this.db.classes[className.toLowerCase()].units[
                unitName.toLowerCase()
            ] === "undefined"
        )
            return false;
    ...
    getNoteById(className, unitName, id) {
        ...
        return this.db.classes[className].units[unitName.toLowerCase()].notes[
            id
        ];
    }
    /**
    ...
    deleteNote(className, unitName, id) {
        ...
        delete this.db.classes[className].units[unitName.toLowerCase()].notes[
            id
        ];
        this.saveAll();
    }
    ...
    deleteTextbook(className, name) {
        ...
        try {
            array.splice(
                array.indexOf(array.find((item) => item.name == name)),
                1
            );
