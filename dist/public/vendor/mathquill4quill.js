...
/**
 * @author Clemens Wolff <https://github.com/c-w>
 * @description Enhanced math formulas for quill
 */
...
window.mathquill4quill = function(dependencies) {
    ...
    function enableMathQuillFormulaAuthoring(quill, options) {
        ...
        const observer = new MutationObserver(() => {
            const isFormulaTooltipActive = !tooltip.classList.contains("ql-hidden") &&
